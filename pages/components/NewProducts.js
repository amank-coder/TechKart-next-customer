    ...
    return(
        ...
        <div className="max-w-[800px] lg:max-w-[1000px] mx-auto px-[20px] py-[20px] font-bold text-2xl pt-8">
            ...
            <div className="flex flex-wrap justify-between gap-4 md:gap-0 mt-4">
                <Link href={'/mobiles'} className="bg-[url('https://media.istockphoto.com/id/1193842936/photo/mobile-communication-concept-global-communication-network.webp?b=1&s=170667a&w=0&k=20&c=oHUUjJBFUM47PBu24btnPFkPiZUd1Cs2jG_2mV4oGds=')] bg-cover p-[20px] rounded-md h-[140px] w-full md:w-[220px] cursor-pointer">
                    <h1 className="text-center text-white">Mobile Phones</h1>
                </Link>
                <div className="bg-[url('https://images.unsplash.com/photo-1610465299993-e6675c9f9efa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80')] bg-cover p-[20px] rounded-md h-[140px] w-full md:w-[220px] cursor-pointer">
                    <h1 className="text-center text-white">Laptops</h1>
                </div>
                <div className="bg-[url('https://www.popsci.com/uploads/2021/03/24/LED_TV_Lights_with_Microphone_and_Camera.jpg?auto=webp')] bg-cover p-[20px] rounded-md h-[140px] w-full md:w-[220px] cursor-pointer">
